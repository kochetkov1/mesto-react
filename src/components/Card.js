...
function Card(props) {
  ...
  const cardDeleteButtonClassName = `${isOwn ? 'photo-grid__delete' : 'photo-grid__delete_hidden'}`;
  ...
  return (
    ...
    <div className="photo-grid__item" key={card._id}>
      <img className="photo-grid__image" src={card.link} alt={card.name} onClick={() => onCardClick(card)} />
